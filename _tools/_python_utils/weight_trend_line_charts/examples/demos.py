...
from utils.weight_intake_exercise_simple import draw_intake_and_weight_exercise
from utils.weight_intake_exercise import plot_weight_intake
from utils.weight_trend import draw_lines_by_month, draw_one_line, draw_one_line_with_range_slider
...
def demo_weight_trend():
    ...
    end_date = datetime(2023, 9, 21)  # 结束日期
    date_format = "%Y年%m月%d日"
...
def demo_weight_intake_exercise_simple():
    ...
    exercise202308 = [
        ...
        [{'k': "abs", 'v': 7}],
        [{'k': "abs", 'v': 10}],
        [{'k': "abs", 'v': 19}, {'k': "dumbbell", 'v': 19}],
        [{'k': "abs", 'v': 20}, {'k': "dumbbell", 'v': 38}],
        [{'k': "abs", 'v': 10}, {'k': "dumbbell", 'v': 17}],
        [{'k': "abs", 'v': 7}],
        [{'k': "abs", 'v': 9}, {'k': "dumbbell", 'v': 15}],
        [{'k': "abs", 'v': 9}],
        [{'k': "abs", 'v': 10}, {'k': "dumbbell", 'v': 15}],
        [{'k': "abs", 'v': 22}, {'k': "dumbbell", 'v': 15}],
        [{'k': "abs", 'v': 6}, {'k': "tabata", 'v': 24}],
        [{'k': "abs", 'v': 6}, {'k': "tabata", 'v': 12}],
        [{'k': "dumbbell", 'v': 15}],
        [{'k': "tabata", 'v': 44}],
        [{'k': "tabata", 'v': 56}]
    ]
    exercise202309 = [
        [{'k': "tabata", 'v': 44}],
        [{'k': "tabata", 'v': 36}, {'k': "dumbbell", 'v': 19}],
        [{'k': "tabata", 'v': 56}, {'k': "dumbbell", 'v': 16}],
        [{'k': "tabata", 'v': 40}],
        [{'k': "tabata", 'v': 44}],
        [{'k': "tabata", 'v': 24}],
        [{'k': "tabata", 'v': 40}, {'k': "dumbbell", 'v': 16}],
        [{'k': "tabata", 'v': 48}],
        [{'k': "tabata", 'v': 24}],
        [{'k': "tabata", 'v': 56}, {'k': "dumbbell", 'v': 15}],
        [{'k': "tabata", 'v': 52}],
        [{'k': "tabata", 'v': 48}, {'k': "dumbbell", 'v': 16}],
        [{'k': "tabata", 'v': 40}, {'k': "dumbbell", 'v': 16}],
        [{'k': "aerobic exercise", 'v': 60}],
        [{'k': "tabata", 'v': 28}, {'k': "dumbbell", 'v': 18}, {'k': "abs", 'v': 20}],
        [{'k': "无", 'v': 0}],
        [{'k': "tabata", 'v': 40}, {'k': "dumbbell", 'v': 20}],
        [{'k': "tabata", 'v': 24}, {'k': "dumbbell", 'v': 20}],
        [{'k': "tabata", 'v': 24}, {'k': "abs", 'v': 15}],
        [{'k': "abs", 'v': 15}, {'k': "walking", 'v': 60}],
        [{'k': "tabata", 'v': 24}, {'k': "dumbbell", 'v': 20}]
    ]
    intake202308 = [{'k': "称菜、瓜子300g", 'v': 3216},
                    {'k': "蛋炒饭、花生100g", 'v': 2074},
    ...
    draw_intake_and_weight_exercise(
        bar_width,
        start_date, end_date,
