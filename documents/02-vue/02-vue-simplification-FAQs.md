...
由于没有系统学习过 vue，工作项目大部分都是了解了简单使用方法就直接上手，根据业务需求，搜索对应资料，解决对应问题。后来有简单浏览过一遍 API 文档，对整体分类及相关功能有了大概了解。
...
![1、词云-jieba关键字分词(top200)&具体问题分词](<pictures/1、词云-jieba关键字分词(top200)&具体问题分词.png>)
...
![vue-mechanism.jpg](pictures-vue/vue-mechanism.jpg)
